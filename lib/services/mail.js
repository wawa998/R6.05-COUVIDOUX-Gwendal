...
module.exports = class MailService extends Service {
    ...
    async mailWhenFavIsDeleted(to, movie) {
        ...
        const info = await tranporter.sendMail({
            ...
            to,
            subject: 'Deleted fav',
            text: 'Your favorite movie : ' + movie + ' , has been deleted.',
            html: `Your favorite movie : ${movie} , has been deleted.`
        });

        console.log('Message sent: %s', info.messageId);
    }

    async sendEmailWithExport(to, filePath) {
